...
import static ru.skubatko.dev.skillsmart.hard.work.task09.refactored.utils.StringUtils.toUpper;
...
import ru.skubatko.dev.skillsmart.hard.work.task09.initial.ReportFileCreator;
...
class ReportFileCreatorRefactoredTest {
    @Mock
    ...
    void shouldCreateFile() {
        ...
        //when
        reportFileCreator.create(toUpper(xEmployeeLogin), toUpper(xEmployeePIN), type, appParameters);
